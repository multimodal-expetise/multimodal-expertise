...
class MMDataset(Dataset):
    ...
    def __init_evaluation(self):
        ...
        try:
           self.info = data['info'].tolist() #(2679, 'XJ52666888$_$379') (2303, 'suyunee$_$571') (473, '91647030$_$802') (2640, 'XJ52666888$_$688') (1527, 'GRNtongxie$_$107') (270, '28_12_20$_$941') (111, '1444972715$_$266') (2248, 'SN851108$_$218') (130, '28_12_20$_$850') (2508, 'XJ52666888$_$298') (
        except:
            self.info = data['info']
        self.raw_text = data['raw_text'].tolist()
        self.labels = {'M': np.array(data['labels'] - 4).astype(np.float32)}  # shift label scale to zero-centered
